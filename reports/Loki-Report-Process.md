...
# Bind9 specific
ssh root@fleur.lavnet.net "journalctl --since='$START_JOURNAL' --until='$END_JOURNAL' --no-pager -u named.service | wc -l"
# Output: 45
```
...
ssh root@fleur.lavnet.net "grep -E '\[30/Dec/2025:(11|12|13):' /var/log/apache2/access.log /var/log/apache2/other_vhosts_access.log /var/log/apache2/error.log 2>/dev/null | wc -l"
# Output: 1632
```
