# Jack and claude notes

This is my first report, we discovered that bind9 (DNS) was going to syslog and not journald.
...
**Raw entries on ispconfig_server**: 12,872
...
**Raw entries on ispconfig_server**: 1,347
**Stored in Loki**: 289
...
ssh root@ispconfig_server.example.com "wc -l /var/log/apache2/access.log /var/log/apache2/other_vhosts_access.log /var/log/apache2/error.log"
# Output: 11463 total

# Filtered by time window (14:00-16:59 on Dec 29)
ssh root@ispconfig_server.example.com "grep -E '\[29/Dec/2025:(14|15|16):' /var/log/apache2/access.log /var/log/apache2/other_vhosts_access.log /var/log/apache2/error.log 2>/dev/null | wc -l"
# Output: 1347
```
